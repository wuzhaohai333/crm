...
<head>
    ...
    <title>首页</title>
    <link rel='Shortcut Icon' type='image/x-icon' href='/win10ui/img/windows.ico'>
...
<div id="win10">
    <div class="desktop">
        <div id="win10-shortcuts" class="shortcuts-hidden">
            ...
            <div class="shortcut" onclick="Win10.openUrl('https://yuri2.cn','<img class=\'icon\' src=\'/win10ui/img/icon/blogger.png\'/>尤里2号的博客')">
                <img class="icon" src="../win10ui/img/icon/blogger.png"/>
                <div class="title">Yuri2's Blog</div>
            </div>
            <div class="shortcut" onclick="Win10.openUrl('win10ui.yuri2.cn/src/doc.php','<img class=\'icon\' src=\'/win10ui/img/icon/doc.png\'/>在线文档')">
                <img class="icon" src="../win10ui/img/icon/doc.png"/>
            ...
            <div class="shortcut" onclick="window.open('https://github.com/yuri2peter/win10-ui/archive/master.zip')">
                <img class="icon" src="../win10ui/img/icon/download.png"/>
    ...
    <div id="win10-menu" class="hidden">
        <div class="list win10-menu-hidden animated animated-slideOutLeft">
            ...
            <div class="sub-item" onclick="Win10.openUrl('/win10ui/child.html','子页')">父子页沟通</div>
        ...
        <div class="blocks">
            <div class="menu_group">
                ...
                <div loc="1,1" size="6,3" class="block">
                    ...
                    <div class="content red cover">
                        <img width="264" style="position: relative;top: -50px;" src="/win10ui/img/presentation/wangyiyun.gif" />
                    </div>
                </div>
            ...
            <div class="menu_group">
                ...
                <div loc="5,2" size="2,2" class="block">
                    <div class="content">
                        <img style="width: 40px;height: 40px;margin: 5px auto;display: block" src="/win10ui/img/icon/baidu.png">
                        <div class="win10-block-content-text">图标按钮</div>
                    </div>
                </div>
                <div loc="1,4" size="6,3" class="block">
                    <div class="content" style="background: url('/win10ui/img/presentation/1.png');background-size: auto">
